...
import { AnnotatedCharacter, character } from "./character.ts";
...
export function getTokenForProvider(
    ...
    character: AnnotatedCharacter | Character
) {
    switch (provider) {
...
export async function initializeClients(
    character: AnnotatedCharacter,
    runtime: IAgentRuntime
) {
    const clients = [];
    const clientTypes = character.clientTypes || [];
...
const startAgents = async () => {
    ...
    let characters: AnnotatedCharacter[] = [character];
